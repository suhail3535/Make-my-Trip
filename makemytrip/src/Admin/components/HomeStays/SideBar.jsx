...
export const Sidebar = () => {
    ...
    const handleChange = (e) => {
        ...
        if (newlocationForSort.includes(value)) {
            newlocationForSort = newlocationForSort.filter(
                (el) => el !== value
            );
        } else {
    ...
    return (
        <div id="mainSideBar">
            <h1 id="heading">Select Filters</h1>

            <div>
                <h2 id="heading">Suggested For You</h2>
            ...
            <div>
                <h1 id="heading">Sort By Price</h1>
            ...
            <div>
                <h1 id="heading">Price per night</h1>
                <div style={{ padding: "7px" }}>
