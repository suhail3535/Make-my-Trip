            ...
            <DIV>
                ...
                <div>
                    <input
                        type="checkbox"
                        value="No stop"
                        checked={category.includes("No stop")}
                ...
                <div>
                    <input
                        ...
                        checked={category.includes("Morning Departures")}
                        onChange={handleChange}
                    />
                ...
                <div>
                    <input
                        type="checkbox"
                        value="vistara"
                        checked={category.includes("vistara")}
                        onChange={handleChange}
                    />
                    <label>Vistara</label>
                </div>
            ...
            <DIV>
                ...
                <div>
                    <input
                        type="checkbox"
                        value="No stop"
                        checked={types.includes("No stop")}
                        onChange={handleType}
                    />
                    <label>Non Stop</label>
                </div>
            ...
            <DIV>
                ...
                <div>
                    <input
                        type="checkbox"
                        value="Air India"
                        checked={category.includes("Air India")}
                        onChange={handleChange}
                    />
                ...
                <div>
                    <input
                        type="checkbox"
                        value="Air Asia"
                        checked={category.includes("Air Asia")}
                        onChange={handleChange}
                    />
                ...
                <div>
                    <input
                        type="checkbox"
                        value="Akasa Air"
                        checked={category.includes("Akasa Air")}
                        onChange={handleChange}
                    />
                ...
                <div>
                    <input
                        type="checkbox"
                        value="Go First"
                        checked={category.includes("Go First")}
                        onChange={handleChange}
                    />
                ...
                <div>
                    <input
                        type="checkbox"
                        value="Spice Jet"
                        checked={category.includes("Spice Jet")}
                        onChange={handleChange}
                    />
