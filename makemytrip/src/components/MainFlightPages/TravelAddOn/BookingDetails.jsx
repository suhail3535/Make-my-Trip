        ...
        <div id={styles.booking}>
            ...
            <div className={styles.bookingDiv}>
                <div
                    ...
                    <div>
                        {" "}
                        <p>Email</p>
                        <input placeholder="Email" className={styles.code} />
                    </div>
                </div>
            </div>
            <h2 style={{ marginLeft: "19%" }}>
            ...
            <div className={styles.bookingDiv}>
                ...
                <div
                    ...
                    <div>
                        ...
                        <p>
                            {" "}
                            Strengthen your safety with COVID insurance of
                            Rs.2,00,000 for hospitalization (new strain
                            covered). Validity 16 days from trip date. TnC Apply{" "}
                    ...
                    <div>
                        <button className={styles.covidButton}>+ADD</button>
                    </div>
                </div>
            </div>
            <div>
            ...
            <div className={styles.bookingDiv}>
                <p style={{ fontSize: "14px", fontWeight: "400" }}>
                    ...
                    <span style={{ color: "#008cff" }}> Fare Rules</span>, the{" "}
                    <span style={{ color: "#008cff" }}>Privacy Policy</span>,
                    the <span style={{ color: "#008cff" }}>User Agreement</span>{" "}
                    and{" "}
