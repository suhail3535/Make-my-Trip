    ...
    return (
        <div id="mainSideBar">
            ...
            <div style={{ padding: "7px" }}>
                ...
                />
                <label className="inpLabel">5 Star</label>
            </div>
            <div style={{ padding: "7px" }}>
                <input
                    className="inp"
            ...
            <div style={{ padding: "7px" }}>
                ...
                <label className="inpLabel">3 Star</label>
            </div>
            <h2 id="heading">Guest Love</h2>
            <div style={{ padding: "7px" }}>
                <input className="inp" type="checkbox" />
                <label className="inpLabel">Swimming Pool</label>
            </div>
            <div style={{ padding: "7px" }}>
                <input className="inp" type="checkbox" />
                <label className="inpLabel">Wi-Fi</label>
            </div>
            <div style={{ padding: "7px" }}>
                <input className="inp" type="checkbox" />
                <label className="inpLabel">Spa</label>
            </div>
        </div>
    );
};
