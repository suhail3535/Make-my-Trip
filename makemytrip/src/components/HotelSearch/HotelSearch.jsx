        ...
        <div className="outer_div_hotel">
            ...
            <div className="location_select_hotel">
                ...
                <div className="location_opt_hotel">
                    <p> </p>ROOMS & GUESTS
                    <div>
                        <span className="first_bold_hotel">{customer}</span>
                        <span className="second_bold">Adults</span>
                        <span>&nbsp;&nbsp;</span>
                        <span>
                            <button onClick={() => seCustomer(customer + 1)}>
                                <AiOutlineUserAdd />
                            </button>
                            /
                            <button
                                onClick={() => seCustomer(customer - 1)}
                                disabled={customer === 1}>
                                <AiOutlineUserDelete />
                            </button>
                        </span>
                ...
                <div className="location_opt_hotel">
                    <p>PRICE PER NIGHT </p>
                    <div className="second_bold_hotel">
                        ₹0-₹1500,₹1500-₹2500,...
                    </div>
                </div>
            </div>
            ...
            <Link href="/hotel">
                <button className="src_btn_hotel" onClick={handleSearch}>
                    SEARCH
                </button>
            </Link>
        </div>
